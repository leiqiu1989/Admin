    ...
    <div class="layui-col-md10">
        <div class="layui-form">
            <div class="layui-form-item">
                ...
                <button class="layui-btn layui-btn-primary layui-btn-sm js-status"><i class="layui-icon">&#xe640;</i>停 用</button>
            </div>
            <table class="layui-hide" lay-data="{id:'terminalTbList'}" id="terminalTbList">
            </table>
        </div>
    </div>
</div>