    ...
    <div class="layui-col-md12">
        ...
        <div class="layui-form">
            <div class="layui-form-item no-margin">
                <label class="layui-form-label">广播类型</label>
                <div class="layui-input-block">
                    <input type="radio" name="sex" value="日常广播" title="日常广播" checked="">
                    <input type="radio" name="sex" value="应急广播" title="应急广播">
                </div>
            </div>
            <hr class="layui-bg-gray">
            <div class="layui-form-item no-margin">
                ...
                <div class="layui-input-block clearfix">
                    <input type="text" class="layui-input w-300 pull-left" placeholder="" />
            ...
            <div class="layui-form-item no-margin">
                ...
                <div class="layui-input-block ">
                    ...
                    <button class="layui-btn">启动广播</button>
                    <button class="layui-btn">设为快捷播发方式</button>
                </div>
            </div>
        </div>
    </div>
